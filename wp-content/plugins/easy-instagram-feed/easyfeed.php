                ...
                <div id="post-body">
                   ...
                   <div id="display_get_beeta" class = "postbox" >
                            <div class="inside">
                                <div id="setting_export_settings_file_text" class="format-settings">
                                    <div class="format-setting-wrap">
                                        <h1>What you get in pro version</h1><hr>
                                            <ol>
                                                <li>
                                                    <h3>Video Type Media Support:</h3>
                                                    <p>In the pro verison you can show video type items in the instagram feed. LightBox Pop Up will play the video.</p>
                                                </li>
                                                <li>
                                                    <h3>Hashtags Support:</h3>
                                                    <p>Get feeds by the hashtags. Say if you set adidas and sports as the tags than you will recieves those media items in feed which have atleast both the tags.  </p>
                                                </li>
                                                <li>
                                                    <h3>Common Hashtags Feed Support:</h3>
                                                    <p>By default Instagram shows all the feeds from the multiple hashtags. Right now instagram did not  have a feature to show feeds common in the multiple hastags. The  pro version does  have a feature to  display only those feeds common in the multiple hashtags.</p>
                                                </li>
                                                <li>
                                                    <h3>User Feed filtering by hashtag:</h3>
                                                    <p>As you know that instagram has no phenomena which allow you to display user feed tagged by specific hash tags, so , we have added a feature to do it.</p>
                                                </li>
                                                <li>
                                                    <h3>Lightbox Support:</h3>
                                                    <p>By default the lightbox is active that if you click on any of the image / video , than you get the nice piece of LightBox  Overlay. In this overlay window you can watch video, navigate to other images, share the items on insatragam  etc etc. You can also disable it if you dint want to use lightbox.    </p>
                                                </li>
                                                <li>
                                                    <h3>Socialise Feeds:</h3>
												...
												<h3>Pricing</h3>
												<p>The pro version is priced at very reasonable 29 USD and entitles you to receive support and updates for 1 year.</p>
                                    ...
                                    <div >
                                        <div>
                                            <p>Like this plugin? Support us by:</p>
                                                ...
                                                <a class="buy-button" target="_blank" href="http://webriti.com/instagram-feed/"><i class="fa fa-usd"></i>Buy It</a>
                                    ...
                                    <div class="format-setting-wrap">
                                        <h1>Common Issues</h1>
                                           ...
                                           <li style="list-style:disc;">
    											...
    											<h4>Wrong Access Token.</h4>
    											<p>After taking all measures mentioned above, if you are still facing the issue, than check wither your access token is correct or not by using this link <b>https://api.instagram.com/v1/users/self/feed?access_token=ACCESS-TOKEN</b>.
    											Replace  ACCESS-TOKEN in the url with your access token . If you get the output as "The access_token provided is invalid" than definitely you are using the wrong access token. Get the correct access token by reauthenticating the plugin as shown in general settings.
    											</p>
											</li>
